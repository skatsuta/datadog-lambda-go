...
type (
	...
	Config struct {
		...
		KMSAPIKey string
		// APIKeySecretARN is the ARN of the AWS Secrets Manager secret that stores your Datadog API key.
...
const (
	...
	// DatadogKMSAPIKeyEnvVar is the environment variable that will be used to retreive the API key
